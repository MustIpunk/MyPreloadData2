...
import com.example.saiful.mypreloaddata.service.DataMangerService;

import java.lang.ref.WeakReference;

import static com.example.saiful.mypreloaddata.service.DataMangerService.CANCEL_MESSAGE;
import static com.example.saiful.mypreloaddata.service.DataMangerService.FAILED_MESSAGE;
import static com.example.saiful.mypreloaddata.service.DataMangerService.PREPARATION_MESSAGE;
import static com.example.saiful.mypreloaddata.service.DataMangerService.SUCCES_MESSAGE;
import static com.example.saiful.mypreloaddata.service.DataMangerService.UPDATE_MESSAGE;
...
public class MainActivity extends AppCompatActivity implements HandlerCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent mBoundServiceIntent = new Intent(MainActivity.this, DataMangerService.class);
        mActivityMessenger = new Messenger(new IncomingHandler(this));
        mBoundServiceIntent.putExtra(DataMangerService.ACTIVITY_HANDLER, mActivityMessenger);
